<template>
	<div class="diy_details_box diy_div_physical_examination_appointment">
		<div class="warp">
			<div class="container">
		...
		methods: {
			...
			change_praise(obj) {
				...
				var query = {
					...
					source_field: "physical_examination_appointment_id",
					source_id: this.obj["physical_examination_appointment_id"],
					user_id
				};
				...
				if (this.state_praise) {
					...
					this.$get('~/api/praise/del?', query, (res) => {
						if(res.result){
							...
							this.$post('~/api/physical_examination_appointment/set?physical_examination_appointment_id=' + _this.obj["physical_examination_appointment_id"], {
								praise_len
							}, (res) => {
								if(res.result){
