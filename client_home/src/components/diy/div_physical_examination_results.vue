<template>
	<div class="diy_details_box diy_div_physical_examination_results">
		<div class="warp">
			<div class="container">
		...
		methods: {
			...
			change_praise(obj) {
				...
				var query = {
					...
					source_field: "physical_examination_results_id",
					source_id: this.obj["physical_examination_results_id"],
					user_id
				};
				...
				if (this.state_praise) {
					...
					this.$get('~/api/praise/del?', query, (res) => {
						if(res.result){
							...
							this.$post('~/api/physical_examination_results/set?physical_examination_results_id=' + _this.obj["physical_examination_results_id"], {
								praise_len
							}, (res) => {
								if(res.result){
